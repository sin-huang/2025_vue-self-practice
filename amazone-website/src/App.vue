...
export default{
      ...
      items: [
        {
          ...
          image:"https://m.media-amazon.com/images/I/611LbnyTYNL._AC_UY218_.jpg"
        },
        {
        ...
        },
        {
            ...
            moreInfo: "See options",
            image:"https://m.media-amazon.com/images/I/61CP3e58SIL._AC_UL320_.jpg"
        },
        {
  ...
  mounted(){
    this.items.forEach((item) => {
        item.discountPrice = (item.price * item.discount).toFixed(2);
    });
  }
}
...
<template>
      <div class="container-fluid mx-6 py-5 text-align">
        <div class="row" v-for="(chunk, index) in chunkedItems" :key="index">
            <product-card v-for="item in items" :key="item.name" :item="item"></product-card>
        </div>
      </div>
</template>
